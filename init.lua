...
function core:init(event, name)
	...
	PBL_.bans.ban_clases = {
		...
		L["dropDownClassDK"],
		L["dropDownClassDH"],
		L["dropDownClassDRUID"],
		L["dropDownClassHUNTER"],
		L["dropDownClassMAGE"],
		L["dropDownClassMONK"],
		L["dropDownClassPALADIN"],
		L["dropDownClassPRIEST"],
		L["dropDownClassROGUE"],
		L["dropDownClassSHAMAN"],
		L["dropDownClassWARLOCK"],
		L["dropDownClassWARRIOR"],
	};
